...
mat1 = gr.material({0.3, 0.3, 0.5}, {0.5, 0.3, 0.5}, 10, 0.0, 0, 0, 1.2)
mat2 = gr.material({0.5, 0.5, 0.5}, {0.5, 0.7, 0.5}, 25)
mat3 = gr.material({1.0, 0.6, 0.1}, {0.5, 0.7, 0.5}, 25)
mat4 = gr.material({0.7, 0.6, 1.0}, {0.5, 0.4, 0.8}, 25, 0.0, 0, 0, 1.2)
...
gr.render(scene, 'images/bump.png', 512, 512,
